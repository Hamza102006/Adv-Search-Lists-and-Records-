...
public class VehicleList {
	...
	public boolean increaseArraySize(int newSize) {
	    if (newSize > this.maxSize) {
	        ...
	        // Display an error message if the entered value is less than the current arraySize
	        JOptionPane.showMessageDialog(null, "Error: Entered size is less than the current array size.");
	        return false;
	    }
	}
